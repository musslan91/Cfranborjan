...
och Hexadecimal_tests definitionerna som pekar inne i main C-filen att de är uppfylda*/
#define CHECK_DEC_TO_BASE(VAR, CVAR, EXPECT, BASE) \
   if(0 == strcmp(CVAR, EXPECT)) \
      ...
      /*Funktioner som pekar på char definitionerna i C-filen där de dem
      testar ifall villkoren stämmer att de är en succes eller en failure.*/
...
#define CHECK_DECFRAC_TO_BASE(VAR, CVAR, EXPECT, BASE) \
   if(0 == strcmp(CVAR, EXPECT)) \
      ...
      /*Funktioner som pekar på char definitionerna i C-filen där de dem
      testar ifall villkoren stämmer att de är en succes eller en failure.
      binary_fraction_tests, och hexadecimal_fraction_tests som båda pekar på
      och tittar ifall convert_to_base_frac funktion/definition stämmer.*/
