...
int main()
{
    ...
    while (exit == false)
    {
        ...
        printf("Välj 2 för: Rtot i parallella kretsar högst 3 resistanser\n");
        printf("Välj 3 för: EFFEKTLAGEN ENKEL P=U*I\n");
        printf("Välj 4 för: SKENBAR EFFEKT ENFAS S=U*I\n");
        printf("Välj 5 för: AKTIV EFFEKT/MEDELEFFEKT ENFAS P=U*I*cos()Fi\n");
        printf("Välj 6 för: SKENBAR EFFEKT 3-FAS S=U*I*cos()Fi\n");
        printf("Välj 7 för: AKTIV EFFEKT 3-FAS P=U*I*cos()Fi*sqrt(3)\n");
